...
function updateCardSelectionTitle() {
    ...
    const titleSets = {
        'today_fortune': [
            "１．<span class='highlight-text'>＜今日の運勢＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "２．<span class='highlight-text'>＜今日の展開＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "３．<span class='highlight-text'>＜アドバイス＞</span>を占います。<br>直感でカードを一枚選んでください。"
        ],
        'love_single': [
            "１．<span class='highlight-text'>＜お相手の今の状況＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "２．<span class='highlight-text'>＜今後の関係性＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "３．<span class='highlight-text'>＜アドバイス＞</span>を占います。<br>直感でカードを一枚選んでください。"
        ],
        'love_couple': [
            "１．<span class='highlight-text'>＜パートナーの今の状況＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "２．<span class='highlight-text'>＜今後の関係性＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "３．<span class='highlight-text'>＜アドバイス＞</span>を占います。<br>直感でカードを一枚選んでください。"
        ],
        'love_reunion': [
        ...
        'work_fortune': [
            "１．<span class='highlight-text'>＜今の環境＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "２．<span class='highlight-text'>＜今後の展開＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "３．<span class='highlight-text'>＜アドバイス＞</span>を占います。<br>直感でカードを一枚選んでください。"
        ],
        'relationship': [
            "１．<span class='highlight-text'>＜今の状況＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "２．<span class='highlight-text'>＜今後の展開＞</span>を占います。<br>直感でカードを一枚選んでください。",
            "３．<span class='highlight-text'>＜アドバイス＞</span>を占います。<br>直感でカードを一枚選んでください。"
        ]
    };
...
function displayFreeResult(result) {
    ...
    const html = `
        ...
        <div style="text-align: center; margin-top: 30px; padding: 20px; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 15px; border: 2px dashed #dacc89;">
           ...
           <button onclick="showPage(13)" style="background: #dacc89; color: white; border: none; padding: 10px 20px; border-radius: 25px; font-size: 13px; font-weight: bold; cursor: pointer; white-space: nowrap; display: block; margin: 0 auto;">
    プレミアム版を見る
</button>
        </div>
    `;
